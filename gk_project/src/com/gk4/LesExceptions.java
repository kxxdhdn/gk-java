...
public class LesExceptions {
    ...
    public static void getData(Scanner sc) throws Exception {
        ...
        if (sc != null) {
            ...
            System.out.println("Donner votre âge (>0) : ");
            int age = sc.nextInt();

            if (age > 0)
                System.out.println("Âge valide : " + age);
            else
                throw new Exception("Votre âge doit être positif.");
        } else
...
//        int tab[] = { 10, 2, 14 };
        ...
        try {
            ...
            System.out.println("Problème de calcul : " + e.getMessage());
        } catch(Exception e) {
            System.out.println("Un autre beug : "+ e.getMessage());
//            e.printStackTrace();
